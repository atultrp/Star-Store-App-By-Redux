...
const Shop = () => {
    ...
    const ItemData = [
        {
            ...
            productDetail: "Sweatshirts are an all-time favorite. Keeping this in mind, Star clothing brings to you this sweatshirt for women which will keep you warm during a chilly winter afternoon.",
            productPrice: "$48"
        },
        {
    ...
    return (
        <div className="container">
            <h2 className="text-center">Shop what you love</h2>
            <div className="row">
